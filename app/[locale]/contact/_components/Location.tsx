...
export default function Location() {
    return (
        <section className="h-auto w-full ">
            <div className=" relative flex h-full w-full flex-col  bg-[#f1efeb] px-24 pt-12 pb-24">
                <div className="flex h-auto w-full mb-10 flex-row justify-center"> Get directions</div>
                <iframe
