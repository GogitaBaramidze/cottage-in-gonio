...
export default function Gallery() {
    ...
    return (
        <section className="order-y-2 relative flex  h-auto flex-col items-center justify-center border-[484848]   bg-letterC bg-contain bg-center bg-no-repeat py-10  md:px-7   md:py-32 lg:px-7 xl:px-0">
