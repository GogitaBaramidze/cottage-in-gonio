...
export default function Wine() {
    ...
    return (
        <section className="grid h-full w-full grid-cols-1 items-start justify-center gap-6   bg-teal-900 px-5 py-5 md:grid-cols-3 md:items-center  md:gap-10 md:px-7  md:py-0 xl:px-10">
